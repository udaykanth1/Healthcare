...
public class Staff extends AppCompatActivity {
    ...
    private void openNewPatient() {
        ...
        final View viewdata = lay.inflate(R.layout.newstaff, null);
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (a.isEmpty()) {
                    Toast.makeText(Staff.this, "Enter Name", Toast.LENGTH_SHORT).show();
                } else if (b.isEmpty()) {

                    Toast.makeText(Staff.this, "Enter Sex", Toast.LENGTH_SHORT).show();
                } else if (c.isEmpty()) {

                    Toast.makeText(Staff.this, "Enter Age", Toast.LENGTH_SHORT).show();
                } else if (d.isEmpty()) {

                    Toast.makeText(Staff.this, "Enter Address", Toast.LENGTH_SHORT).show();
                } else if (e.isEmpty()) {

                    Toast.makeText(Staff.this, "Enter Status", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPaypall(String user, String pass, String c, String d, String e) {
        ...
        reference = database.getReference("Staff Records");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Staff.this, "Staff Added Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(Staff.this, "Failed..", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadData() {
        if (namehere != null) {
            ...
            if (namehere.equalsIgnoreCase("Staff Records")) {
...
//                    upload.setCondition(status);
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(Staff.this, "Error..!!"+databaseError, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void openInfor(String name) {
        ...
        Intent intent=new Intent(Staff.this, ViewInfor.class);
